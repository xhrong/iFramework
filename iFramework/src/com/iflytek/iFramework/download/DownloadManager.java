...
//			provider.deleteDownloadTask(task);
    ...
    void onUpdateDownloadTask(final DownloadTask task, final long finishedSize, final long trafficSpeed) {
    ...
    private boolean isTaskExist(DownloadTask task) {
        Iterator<DownloadTask> iterator = taskOperators.keySet().iterator();
        while (iterator.hasNext()) {

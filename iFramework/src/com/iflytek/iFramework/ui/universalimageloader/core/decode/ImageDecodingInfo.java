...
public class ImageDecodingInfo {
	...
	/** @return Original {@linkplain com.iflytek.iFramework.ui.universalimageloader.utils.MemoryCacheUtils#generateKey(String, ImageSize) image key} (used in memory cache). */

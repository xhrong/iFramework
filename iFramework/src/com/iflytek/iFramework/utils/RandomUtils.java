...
public class RandomUtils {
     ...
     * @param length
     * @return
     * @see com.iflytek.iFramework.utils.RandomUtils#getRandom(String source, int length)
     */
     ...
     *         <li>else see {@link com.iflytek.iFramework.utils.RandomUtils#getRandom(char[] sourceChar, int length)}</li>
     *         </ul>
     */
